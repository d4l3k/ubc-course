...
exports.index = function(req, res) {
	pg.connect("postgres://postgres:@localhost/ubcourses", function(err, client, done)
	{
		...
		client.query('INSERT INTO reviews("like", useful, easy, text, course_id, field) values( $1, $2, $3, $4, $5, $6)', [req.param("like"),
		req.param("useful"), req.param("easy"), req.param("text"), req.param("id"), req.param("foi")], function(err, result)
		{
			if(err)
			{
